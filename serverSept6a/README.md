...
├── emailService.ts         # Email service for sending notifications (Gmail/Nodemailer)
...
#### `emailService.ts`
Email notification service using Gmail through Nodemailer:
...
- **nodemailer** - Gmail email transport
